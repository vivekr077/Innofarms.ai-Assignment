...
export default function Footer() {
  return (
    <footer className="w-full bg-white pt-10">
      {/* Top Bar Section */}
      <div className="w-full bg-[#3D550C] py-12">
        <div className="w-full px-4 md:px-6 lg:px-6 xl:px-16">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            {/* Left Content */}
            <div className="text-[#DCBC88] font-bold font-spartan text-xl md:text-2xl lg:text-3xl uppercase">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[#FFFFFF] font-signika text-sm md:text-base font-normal">
                  +91 92203 09252
                </span>
              </div>
        ...
        <div className="w-full px-4 md:px-6 lg:px-8 xl:px-20">
          <div className=" mx-auto">
            ...
            <div className="flex flex-col lg:flex-row gap-8 md:gap-12 lg:gap-16 items-start">
              ...
              <div className="lg:w-1/3 flex flex-col -mt-4 lg:-mt-8 items-start">
                {/* Row 1: Logo */}
                <div className="mb-6 -ml-4 md:-ml-7">
                  <Image
                ...
                {/* Row 2: Description */}
                <p className="text-sm md:text-base max-w-[80%] font-normal text-[#404A3D] mb-6 font-roboto leading-relaxed">
              ...
              <div className="lg:w-2/3 flex flex-col">
                {/* Row 1: Tagline */}
                <h1 className="text-2xl md:text-3xl lg:text-[40px] max-w-[80%] font-bold text-[#1E1E1E] mb-8 md:mb-8 font-spartan">
                  India&apos;s First Premium Culinary Innovation Brand.
                </h1>

                {/* Row 2: Three Columns */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-8 md:mb-12 max-w-[90%]">
                  {/* Useful Link Column */}
                  <div>
